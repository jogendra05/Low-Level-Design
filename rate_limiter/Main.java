...
import rate_limiter.service.RateLimiterServies;

public class Main {
    static void checkConcurrency(RateLimiterServies rateLimiterService) throws InterruptedException {
    ...
    public static void main(String[] args) throws InterruptedException {
        RateLimiterServies rateLimiterService = new RateLimiterServies();
